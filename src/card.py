...
class Card:
    ...
    def calculate_base_position(self):
        ...
        if self.location_number == 5: #miejsca dla kart tymczasowych
            return h13_centerx, self.screen_height - h13_centery - 3 * self.card_size[0]
        if self.location_number == 6: #miejsca dla karty tymczasowych
            return h13_centerx + 3 * (self.card_size[0] + gap_12), self.screen_height - h13_centery - 3 * \
                   self.card_size[0]
